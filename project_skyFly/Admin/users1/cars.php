...
<table class="table table-striped table_id" id="example">
    ...
    <tbody>
      <?php
        $idu=$_SESSION['id'];
        $query="select cars.price,cars.idc,cars.name,cars.fuel_consmption,cars.capacity,get_car.Receiving_date ,get_car.Days,get_car.Time from cars JOIN get_car ON cars.idc=get_car.id_c
        where id_u='$user'
        ;";
      ...
      <tr>
        ...
        <td><?php echo $arr['Receiving_date'];?></td>
            <td><?php echo $arr['Time'];?></td>
        <td><?php echo $arr['Days'];?></td>
    
        <td><a href='cars?idc=<?php echo $arr['idc']; ?>'  class='btn btn-danger'>Delete</a></td>
      </tr>
    <?php
       }
    ?>
...
$id_car=$_GET["idc"];
$id_user=$_SESSION['id'];
$query="delete from get_car where id_c='$id_car'and id_u='$user'";
