...
<table class="table table-striped table_id" id="example">
    ...
    <tbody>
      <?php
        $idu=$_SESSION['id'];
        $query="select flight.idf,flight.departd,flight.returnd,flight.departt,flight.returnt,flight.price,flight.flocation from flight JOIN get_plane on flight.idf=get_plane.id_p where id_u={$_SESSION['id']}
        ;";
      ...
      <tr>
        ...
        <td><a href='flight.php?idf=<?php echo $arr['idf']; ?>' class='btn btn-danger'>cancle</a></td>
      </tr>
    <?php
       }
    ?>
...
$id_flight=$_GET["idf"];
$id_user=$_SESSION['id'];
$query="delete from get_plane where id_p='$id_flight' and id_u='{$_SESSION['id']}'";
