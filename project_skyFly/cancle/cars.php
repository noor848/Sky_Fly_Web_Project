...
<link href="https://fonts.googleapis.com/css2?family=Redressed&display=swap" rel="stylesheet"><link rel="stylesheet" href="https://cdn.datatables.net/1.10.23/css/dataTables.bootstrap4.min.css">
...
<table class="table table-striped table_id" id="example">
    ...
    <tbody>
      <?php
        $idu=$_SESSION['id'];
        $query="select cars.price,cars.name,cars.fuel_consmption,cars.capacity,cars.image,cars.idc from cars JOIN get_car ON cars.idc=get_car.id_c
        where id_u= $idu
        ;";
      ...
      <tr>
        ...
        <td><img  class="img-fluid"src="../cars/<?php echo $arr['image'];?>"  width="150" alt=""/></td>
        <td><a href='cars.php?idc=<?php echo $arr['idc']; ?>' class='btn btn-danger'>cancle</a></td>
      </tr>
    <?php
       }
    ?>
...
$id_car=$_GET["idc"];
$id_user=$_SESSION['id'];
$query="delete from get_car where id_c='$id_car' and id_u='{$_SESSION['id']}'";
